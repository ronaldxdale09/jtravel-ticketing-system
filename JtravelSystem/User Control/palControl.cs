...
{
    public partial class palControl : UserControl
    {
        public palControl()
        {
            InitializeComponent();
        ...
        private void buttonSave_Click(object sender, EventArgs e)
        {
            ...
            else if (String.IsNullOrEmpty(richTextGuessDetails.Text))
            {
                ...
                Object oTemplatePath = System.IO.Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments), "JtravelTicket/TicketTemplate", "palTemplate.dotx");
                ...
                foreach (Field myMergeField in wordDoc.Fields)
                {
                    ...
                    if (fieldText.StartsWith(" MERGEFIELD"))
                    {
                        ...
                        if (fieldFlightDate == "flightDate")
                        {

                            myMergeField.Select();

                            wordApp.Selection.TypeText(DateFlightDate.Value.ToString("MM-dd-yyyy"));
        ...
        {
            palSendEmail palSendEmail = new palSendEmail();
            palSendEmail.Show();
